...
class Car {
  ...
  private boolean
    engine = false, driveTrain = false, wheels = false,exhaustSystem=false,carcase=false,guards=false;
  ...
  public synchronized void addExhaustSystem() { exhaustSystem = true; }
  public synchronized void addCarcase() { carcase = true; }
  public synchronized void addGuards() { guards = true; }
  public synchronized String toString() {
    return "Car " + id + " [" + " engine: " + engine
      + " driveTrain: " + driveTrain
      + " wheels: " + wheels + " exhaust system: "+exhaustSystem + " carcase: " + carcase
      + " guards: " + guards + " ]";
  }
}
  ...
  public void run() {
    try {
      while(!Thread.interrupted()) {
        ...
        robotPool.hire(GuardsRobot.class, this);
...
class GuardsRobot extends Robot {
	  public GuardsRobot(RobotPool pool) { super(pool); }
	  protected void performService() {
	    System.out.println(this + " installing Guards");
	    assembler.car().addGuards();
	  }
	}
...
public class CarBuilder {
  public static void main(String[] args) throws Exception {
    ...
    exec.execute(new GuardsRobot(robotPool));
